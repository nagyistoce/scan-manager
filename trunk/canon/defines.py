...
# Error code masks
#
ERROR_COMPONENTID_MASK					= 0x00F00000L
ERROR_ERRORID_MASK						= 0x0000FFFFL

#
# PRSDK Base Component IDs
#
ErrorComponentID = ENUM()
ErrorComponentID.PTP                              = (0x00100000L,'PTP operation errors')
ErrorComponentID.PRSDK                            = (0x00200000L,'PRSDK Internal Error')
ErrorComponentID.WIA_STI                          = (0x00300000L,'Errors generated by the Windows WIA/STI')
ErrorComponentID.WINDOWS                          = (0x00400000L,'Errors generated by the GetLastError() function in WIN32 API')
ErrorComponentID.COMIF                            = (0x00500000L,'Windows COM I/F errors')
...
SDKErrorCode.UNIMPLEMENTED                            = 0x00000001L
SDKErrorCode.INTERNAL_ERROR                           = 0x00000002L
SDKErrorCode.MEM_ALLOC_FAILED                         = 0x00000003L
SDKErrorCode.MEM_FREE_FAILED                          = 0x00000004L
SDKErrorCode.OPERATION_CANCELLED                      = 0x00000005L
SDKErrorCode.INCOMPATIBLE_VERSION                     = 0x00000006L
SDKErrorCode.NOT_SUPPORTED                            = 0x00000007L
SDKErrorCode.UNEXPECTED_EXCEPTION                     = 0x00000008L
SDKErrorCode.PROTECTION_VIOLATION                     = 0x00000009L
SDKErrorCode.MISSING_SUBCOMPONENT                     = 0x0000000AL
SDKErrorCode.SELECTION_UNAVAILABLE                    = 0x0000000BL
# Function Parameter errors 
SDKErrorCode.INVALID_PARAMETER                        = 0x00000021L
SDKErrorCode.INVALID_HANDLE                           = 0x00000022L
# ...
SDKErrorCode.INVALID_FN_CALL                          = 0x00000061L
SDKErrorCode.WAIT_TIMEOUT_ERROR                       = 0x00000062L
SDKErrorCode.INSUFFICIENT_BUFFER                      = 0x00000063L
SDKErrorCode.EVENT_CALLBACK_EXIST                     = 0x00000064L
